...
- **Word: TESTED**, on DCIC: 80 files, valid against Word's schema, with 38 decorative images marked. Read back, 44 of 80 pages give the same HTML; most of the rest put a list inside a quotation, which Word can't hold as structure.
- **PDF: NOT YET IMPLEMENTED.**
